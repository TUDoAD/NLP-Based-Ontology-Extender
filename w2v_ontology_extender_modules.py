...
def ontology_class_annotator(ontology_files_to_extend = ["./ontologies_output/Allotrope_OWL_ext_methanation_only_text_mc1_0.999"],
    ...
    use_IUPAC_goldbook : TYPE, optional
        DESCRIPTION. The default is True.
    provenance_string : TYPE, optional
        DESCRIPTION. The default is "AB".
    ...
    for ontology_filename in ontology_files_to_extend:
        ...
        # add annotation string(s) as rdfs:comment
        with onto_local:
            ...
            # list number of unique classes added via word2vec as subclass of w2vConcept
            w2vSubclasses = len(set(list(onto_local.w2vConcept.subclasses())))
            # store modified ontology in ./ontologies_output/ 
            onto_local.save(file = ontology_filename + "_output.owl")
