...
def ontology_class_extender(ontology_filenames = ["SBO"], 
    ...
    metrics_dict = {'min_count': modelname_metrics_list,'similarity_threshold':sim_list,'new_classes':new_classes_list,'unique_keys':unique_list, 'model_token_number':model_token_number, 'unique_len_all_concepts_found':unique_len_all_concepts_found}
...
def ontology_class_annotator():
    ...
    for ontology_filename in ontology_filename_list:
        ...
        [class_dict, desc_dict] = onto_loader(["chmo","Allotrope_OWL", "chebi", "NCIT", "bao_complete_merged", "SBO"])
